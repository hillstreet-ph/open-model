...
Repository: `hillstreet-ph/open-model`  
...
Existing .github/workflows/release.yaml is canonical. This repository replaces open-box.

## Docker contract

Existing multi-platform release workflow and its release environment are canonical.
